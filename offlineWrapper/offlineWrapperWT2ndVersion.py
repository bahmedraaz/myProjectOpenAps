...
for file in glob.glob("data_*.csv"):
	...
	writeNumDetection = open("WT2nd_"+file_name+".txt", "w")
	writeNumDetection.write("Number of Alarm: "+str(numDetection)+"\n")
	writeNumDetection.close()

	## Add Alarm Time
	appendAlamrTime = open("WT2nd_"+file_name+".txt", "a")
	...
	appendClassificationReport = open("WT2nd_"+file_name+".txt", "a")
